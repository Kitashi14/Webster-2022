...
<div className="px-3 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-10 bg-[url('https://www.toptal.com/designers/subtlepatterns/uploads/dot-grid.png')}">
        ...
        <div className="w-full   bg-indigo-600 shadow-xl shadow-indigo-200 py-10 px-20 flex justify-between items-center">
            <p className=" text-white"> <span className="text-4xl font-medium">Still Confused ?</span> <span className="text-lg">Book For Free Career Consultation Today ! </span></p>
